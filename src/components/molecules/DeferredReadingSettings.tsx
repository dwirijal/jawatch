...
export function DeferredReadingSettings({
  ...
  return (
    <Button
      ...
      className="h-[var(--size-control-md)] w-[var(--size-control-md)] rounded-[var(--radius-sm)] border-border-subtle bg-surface-1 text-foreground hover:bg-surface-elevated hover:text-foreground"
