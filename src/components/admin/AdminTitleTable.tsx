  ...
  return (
    <Paper tone="muted" shadow="sm" className="overflow-hidden">
      <div className="border-b border-border-subtle p-5">
        ...
        <p className="text-sm text-zinc-400">Search, metadata, availability, release date overrides, and visibility summaries.</p>
      </div>
      <div className="divide-y divide-border-subtle">
        {titleRows.map((row) => (
          <div key={row.title} className="grid gap-3 p-5 text-sm md:grid-cols-4">
