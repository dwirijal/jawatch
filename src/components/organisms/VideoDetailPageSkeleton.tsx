    ...
    <div className="app-shell" data-theme={theme} data-view-mode="comfortable">
      <div className="app-container-wide flex flex-col gap-12 pb-6 pt-8 md:gap-16">
        <section className="relative overflow-hidden rounded-[var(--radius-2xl)] border border-border-subtle bg-surface-1 hard-shadow-md">
          ...
          <div className="relative z-10 px-[var(--space-lg)] py-5 md:px-7 md:py-7">
            <nav className="mb-6">
            ...
            <SplitLayout
              mobileGoldenRows
              breakpoint="lg"
              className="items-end gap-[var(--space-xl)]"
              stage={
                <div className="space-y-5">
                  ...
                  <div className="space-y-3">
                    ...
                    <Skeleton className="h-[var(--size-control-lg)] max-w-2xl rounded-xl" />
                  ...
                  <div className="flex flex-wrap items-center gap-[calc(var(--space-xs)+var(--space-2xs))]">
                    <Skeleton className="h-[var(--size-control-lg)] w-44 rounded-[var(--radius-lg)]" />
                    <Skeleton className="h-[var(--size-control-lg)] w-32 rounded-[var(--radius-lg)]" />
                  </div>
                </div>
              }
              gallery={
                <div className="space-y-3.5">
                  ...
                  <div className="grid gap-[calc(var(--space-xs)+var(--space-2xs))] sm:grid-cols-2 lg:grid-cols-1">
                    {Array.from({ length: 4 }).map((_, index) => (
                      <Paper key={index} tone="muted" shadow="sm" className="space-y-2 px-[calc(var(--space-sm)+var(--space-2xs))] py-[var(--space-sm)]">
          ...
          stage={
            <div className="space-y-8">
              <section className="space-y-5">
                ...
                <Paper tone="muted" shadow="sm" className="space-y-3 p-[var(--space-lg)] md:p-6">
          ...
          gallery={
            <div className="space-y-5">
              <Paper tone="muted" shadow="sm" className="space-y-3 p-[var(--space-lg)] md:p-6">
                ...
                <Skeleton className="h-[calc(var(--size-control-md)-var(--space-2xs))] w-full rounded-[var(--radius-lg)]" />
              </Paper>
              <Paper tone="muted" shadow="sm" className="space-y-3 p-[var(--space-lg)] md:p-6">
                <Skeleton className="h-4 w-20 rounded-full" />
                {Array.from({ length: 4 }).map((_, index) => (
                  <Skeleton key={index} className="h-[var(--size-control-lg)] w-full rounded-[var(--radius-lg)]" />
                ))}
              </Paper>
            </div>
          }
