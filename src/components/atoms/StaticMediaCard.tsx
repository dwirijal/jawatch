...
import { cn, getMediaPosterAspectClass, THEME_CONFIG, type ThemeType } from '@/lib/utils';
...
function getAccent(href: string | undefined, title: string, theme: ThemeType): string {
  ...
  const accentPalette = palette[theme] ?? palette.default;
  ...
  const cardBody = (
    ...
    >
      ...
      <div className="relative h-full overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(to_top,rgba(4,4,8,0.96)_0%,rgba(4,4,8,0.62)_26%,rgba(4,4,8,0.18)_48%,rgba(4,4,8,0.2)_100%)]" />
        <div
