    ...
    <section className="rounded-[var(--radius-sm)] border border-border-subtle bg-surface-1 p-6">
      <div className="flex items-center justify-between gap-4">
        ...
        {OPTIONAL_STEPS.has(currentStep) ? (
          <p className="text-xs uppercase tracking-[0.16em] text-zinc-500">Optional Step</p>
        ) : (
          <p className="text-xs uppercase tracking-[0.16em] text-zinc-500">Required Step</p>
        )}
      </div>
