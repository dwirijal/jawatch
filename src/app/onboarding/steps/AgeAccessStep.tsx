export function AgeAccessStep({
  ...
  return (
    <form action={action} className="space-y-4">
      <div>
        <h2 className="text-sm font-black uppercase tracking-[0.16em] text-zinc-200">Age And Access</h2>
        <p className="mt-2 text-sm text-zinc-400">Set your birth date and adult-content preference.</p>
      </div>
      ...
      <label className="flex items-start gap-3 rounded-[var(--radius-sm)] border border-border-subtle bg-surface-2 p-3">
        ...
        <span className="text-sm text-zinc-300">
          I am 21+ and I want to enable adult content in regular catalog routes.
        </span>
      </label>
