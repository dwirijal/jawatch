...
export const metadata: Metadata = {
  title: 'Vault Saved',
  description: 'Saved bookmarks and favorites in your Vault on jawatch.',
  robots: {
    index: false,
    follow: false,
  },
      ...
      <div className="app-container space-y-8 py-4 sm:py-6">
        <section className="surface-panel-elevated p-6 sm:p-8">
          <div className="space-y-3">
            ...
            <h1 className="font-[var(--font-heading)] text-4xl tracking-tight text-zinc-900">Saved</h1>
            <p className="max-w-2xl text-sm leading-6 text-zinc-500">
              Bookmarks and favorites saved on this device.
            </p>
          </div>
          <div className="mt-4">
            <Link
        ...
        <SavedContentSection title="Vault Saved" />
      </div>
    </main>
  );
}
