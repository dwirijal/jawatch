...
import DrachinEpisodeClient from '../../../../drachin/episode/[slug]/DrachinEpisodeClient';
...
export default async function ShortSeriesWatchPage({ params, searchParams }: PageProps) {
    ...
    return (
      <PageStateScaffold>
        <StateInfo
          ...
          description="This short-series episode could not be loaded."
        />
      </PageStateScaffold>
    );
  }
